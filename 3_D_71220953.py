...
while True:
    ...
    for i in range(1):
        hasil1 = print(f'Ketinggian drone pada menit ke-5 adalah {tinggi_awal} meter')
        hasil2 = print(f'Selisih ketinggian drone saat menit ke-5 dan ke-6 adalah {selisih} meter')
